<h2>690. Employee Importance</h2><h3>Medium</h3><hr><div><p>You have a data structure of employee information, including the employee's unique ID, importance value, and direct subordinates' IDs.</p>
...
<pre style="position: relative;"><strong>Input:</strong> employees = [[1,5,[2,3]],[2,3,[]],[3,3,[]]], id = 1
...
<pre style="position: relative;"><strong>Input:</strong> employees = [[1,2,[5]],[5,-3,[]]], id = 5
