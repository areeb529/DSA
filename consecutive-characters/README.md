...
<pre style="position: relative;"><strong>Input:</strong> s = "triplepillooooow"
<strong>Output:</strong> 5
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 4:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> s = "hooraaaaaaaaaaay"
<strong>Output:</strong> 11
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 5:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> s = "tourist"
