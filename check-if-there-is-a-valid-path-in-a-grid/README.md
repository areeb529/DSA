<h2>1391. Check if There is a Valid Path in a Grid</h2><h3>Medium</h3><hr><div><p>You are given an <code>m x n</code> <code>grid</code>. Each cell of <code>grid</code> represents a street. The street of <code>grid[i][j]</code> can be:</p>
